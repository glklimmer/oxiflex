...
with open('problems/slow_convergence/data/iterations_small.json', 'r') as file:
    data = json.load(file)
...
plt.title("Slow Convergence Problem Iterations (Averaged over 5 Runs)")
plt.xlabel("n")
plt.ylabel("Iterations")
plt.xticks(n_values_int)  # Set x-axis ticks to the correct problem sizes
plt.legend()
plt.grid(True)
plt.savefig("problems/slow_convergence/plots/iterations_small.png")
