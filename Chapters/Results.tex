...
~\cref{fig:queens:time} shows the runtime comparison for the N-Queens Problem (See~\ref{sec:queens}:~\nameref{sec:queens}) with $n = 8..20$. ~\cref{fig:queens:iterations} shows benchmarks with the same parameters for measurements of iterations.
